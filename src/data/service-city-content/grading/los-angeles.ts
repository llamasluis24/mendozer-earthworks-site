...
export const gradingLosAngeles: ServiceCityPageContent = {
  metaDescription:
    "Commercial grading in Los Angeles, CA. Urban haul route planning, multi-agency permit coordination, utility-dense mass excavation, and GPS pad certification with community impact controls across LA County.",
  ...
  siteVisitItems: [
    ...
    },
    {
      ...
      lead:
        "Deliver itemized grading bid with production rates, import/export assumptions, and permit hold points tied to your LA vertical mobilization date.",
      checkpoints: [
        "Deliver itemized grading bid with production rates.",
  ...
  evaluationSteps: [
    ...
    },
    {
      ...
      body: "Itemized bid with cut/fill quantities, compaction specifications, GPS fine grading tolerances, import/export logistics, and realistic production rates for constrained Los Angeles commercial parcels.",
    },
  ],
  ...
  localBenefits: [
    {
      ...
      body: "mass grading and fine grading production sized for dense Los Angeles commercial corridors with haul route planning and phased access that protects GC vertical schedules.",
    },
    {
  ...
  serviceIssues: [
    ...
    },
    {
      ...
      body: "LA County and city-specific grading permit requirements vary by jurisdiction, cut/fill volume, and environmental triggers. Late permit clarity or missed SWPPP compliance collapses the schedule buffer before pad certification and foundation layout.",
    },
    {
  ...
  faqs: [
    {
      q: "Do you provide commercial grading in Los Angeles, CA?",
      a: "Yes. Mendozer X Earthworks Inc. (Lic. #1069854) self-performs mass excavation, fine grading, soil compaction, and engineered pad prep for developers, GCs, and industrial property owners on Los Angeles commercial redevelopment parcels.",
    },
    {
    ...
    {
      q: "Do you perform GPS and laser-guided fine grading in Los Angeles?",
      a: "Yes. Our late-model dozers and motor graders execute GPS and laser-guided fine grading to civil plan tolerances on Los Angeles commercial building pads, parking areas, and access roads.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes. We execute phased mass grading and fine grading on active commercial properties with sequenced work zones, dust mitigation, and haul routing that preserves adjacent tenant access and distribution traffic flow.",
    },
    {
    ...
    {
      q: "Do you coordinate pad certification with soils engineers in Los Angeles?",
    ...
    {
      q: "How do I request a Los Angeles grading estimate?",
  ...
  caseStudies: [
    {
      title: "Placeholder — Los Angeles Urban Warehouse Pad Prep",
      location: "Los Angeles, CA · Urban Industrial Redevelopment",
      scope: "Mass grading, structural fill placement, compaction, and GPS fine grading on a 2.8-acre distribution facility pad in a dense LA commercial corridor prior to foundation mobilization.",
    ...
    },
    {
      ...
      scope: "Cut/fill balancing, utility trench excavation, and fine grading on an LA County logistics parcel with dense wet and dry infrastructure beneath the industrial yard.",
  ...
  media: {
    photos: [
      ...
      { src: pavingImg, caption: "Placeholder — GPS fine grading on LA commercial building pad" },
    ...
    video: {
      ...
      caption: "Placeholder — Los Angeles commercial grading site walk",
    },
  },
  ...
  tabbedInsights: {
    siteConditions: [
      ...
      "Alluvial and variable soils exposed during mass cut may require over-excavation, structural fill import, and geotech-coordinated remediation before pad certification on LA County sites.",
    ],
    ourApproach: [
      ...
      "GPS fine grading, moisture-conditioned compaction, and community impact controls maintained throughout earthwork on Los Angeles's heavily enforced commercial corridors.",
    ],
    localPermits: [
      ...
      "Compaction testing and pad certification inspection hold points coordinated with geotechnical engineer and city building officials.",
