...
export const gradingSanBernardino: ServiceCityPageContent = {
  metaDescription:
  ...
  evaluationSteps: [
    ...
    },
    {
      ...
      body: "Itemized bid with mass excavation methods, large-lot cut/fill quantities, moisture conditioning and compaction allowances, county agency coordination, and realistic pad certification timeline for San Bernardino commercial redevelopments.",
    },
  ],
  ...
  localBenefits: [
    ...
    },
    {
      ...
      body: "mass grading and unsuitable soil remediation sequenced around geotechnical recommendations on legacy San Bernardino manufacturing parcels with undocumented fill and variable subsurface conditions.",
    },
    {
      title: "County Agency Coordination",
    ...
    {
      title: "Pad Certification Handoff",
      body: "Proof-rolling, density testing coordination, and fine grading turnover documentation aligned with your geotechnical engineer for inspector sign-off before vertical construction mobilizes on San Bernardino pads.",
    },
  ],
  ...
  serviceIssues: [
    ...
    },
    {
      ...
      body: "Multi-acre San Bernardino redevelopments generate cut/fill volumes that exceed on-site balance without disciplined haul planning. Underestimated export or import quantities inflate earthwork cost and collapse GC milestones before pad certification.",
    },
    {
    ...
    },
    {
      ...
      body: "San Bernardino County grading inspection and environmental health review on legacy industrial parcels can extend permit timelines beyond GC float. Earthwork production without county coordination hold points leaves pad certification without schedule recovery buffer.",
    },
  ],
  ...
  faqs: [
    ...
    {
      q: "What compaction and pad certification do you provide in San Bernardino?",
    ...
    },
    {
      ...
      a: "Yes. GPS and laser-guided fine grading on dozers and motor graders delivers civil plan tolerances for building pads, access roads, and storm drain flow lines on San Bernardino warehouse and industrial redevelopments.",
    },
    {
      q: "How do SWPPP requirements apply to San Bernardino large-lot grading?",
      a: "Active grading on expansive San Bernardino parcels requires BMP installation, sediment control, track-out prevention, and daily maintenance meeting county enforcement standards. We maintain SWPPP compliance from mobilization through pad certification.",
    },
    {
      q: "How do I request a San Bernardino grading estimate?",
      a: "Contact us with your San Bernardino project address, civil grading plans, geotechnical report, and target pad certification date. We walk the site and respond within one business day with large-lot scope assumptions and county coordination notes.",
    },
  ],
  ...
  caseStudies: [
    {
      ...
      scope: "Mass grading, cut/fill balancing, and structural pad certification across a 4.8-acre former manufacturing parcel prior to new logistics warehouse construction.",
    ...
    },
    {
      ...
      scope: "Large-lot mass grading, storm drain rough grading, and fine grading turnover on a former steel-frame warehouse parcel being repositioned for distribution use.",
  ...
  media: {
    photos: [
      ...
      { src: g3, caption: "Placeholder — GPS fine grading on San Bernardino warehouse pad" },
  ...
  tabbedInsights: {
    ...
    ourApproach: [
      ...
      "Moisture conditioning, controlled lifts, and density testing coordinated with your geotechnical engineer throughout mass grading and fine grading production.",
      "County agency inspection hold points, SWPPP BMP maintenance, and environmental health coordination managed from mobilization through pad certification.",
    ],
    localPermits: [
