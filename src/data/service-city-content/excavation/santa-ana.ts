...
export const excavationSantaAna: ServiceCityPageContent = {
  metaDescription:
    "Commercial excavation in Santa Ana, CA. Urban OC infill pad prep, county seat agency coordination, dense staging earthwork, and Orange County grading permits for Santa Ana commercial redevelopments.",
  ...
  siteVisitItems: [
    ...
    },
    {
      ...
      lead:
        "Deliver itemized excavation bid with dense staging assumptions, phased production scope, and Orange County inspection sequencing within one business day.",
      checkpoints: [
        "Deliver itemized excavation bid with dense staging assumptions.",
  ...
  evaluationSteps: [
    ...
    },
    {
      ...
      body: "Itemized bid with phased mass excavation methods, dense staging allowances, compaction lift schedules, excavation depths and trenching scope, and realistic production tied to your Santa Ana commercial pad turnover date.",
    },
  ],
  ...
  localBenefits: [
    {
      ...
      body: "Phased mass excavation and utility trenching on dense Santa Ana urban infill parcels with tight staging, alley access coordination, and export hauling sized for county seat commercial redevelopments.",
    },
    {
      title: "County Seat Agency Coordination",
      body: "Grading permit pathways, Orange County review timelines, and inspection hold points aligned with City of Santa Ana building division and county seat agency requirements before excavation sequencing.",
    },
    {
    ...
    {
      title: "Commercial Infill Cut/Fill",
      body: "mass excavation and cut/fill, proof-rolling, and engineered excavation sequencing for office, retail, and mixed-use commercial building pads across Santa Ana urban Orange County infill corridors.",
    },
  ],
  ...
  serviceIssues: [
    ...
    },
    {
      ...
      body: "Cut-heavy Santa Ana infill sites require daily export through tight urban haul routes and alley access. Underestimated staging and haul logistics force material stockpiling on pad footprints and delay GPS utility trenching before tenant mobilization.",
    },
    {
  ...
  faqs: [
    {
      q: "Do you perform commercial excavation in Santa Ana, CA?",
      a: "Yes. Mendozer X Earthworks Inc. (Lic. #1069854) self-performs mass excavation, cut/fill balancing, compaction, GPS utility trenching, and engineered pad prep on urban infill office, retail, and mixed-use commercial projects throughout Santa Ana and Orange County.",
    },
    {
      q: "Can you grade on dense urban infill parcels in Santa Ana?",
      a: "Yes. We execute phased mass excavation and utility trenching on constrained Santa Ana infill sites with tight staging, alley access coordination, and daily export hauling — sized for county seat commercial redevelopments where large-lot earthwork methods are not feasible.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes. We execute phased mass excavation on active Santa Ana urban properties with controlled haul routes, dust suppression, and sequenced work zones that preserve adjacent tenant operations and county seat street frontage.",
    },
    {
    ...
    {
      q: "How do I request a Santa Ana excavation estimate?",
      a: "Contact us with your Santa Ana project address, civil grading plans, geotechnical report, SWPPP status, and target excavation sequencing date. We walk the site and respond within one business day with cut/fill assumptions and county seat inspection sequencing.",
    },
  ],
  ...
  caseStudies: [
    {
      ...
      scope: "Phased mass excavation, cut/fill balancing, compaction, and GPS utility trenching on a dense urban infill commercial building pad with alley staging and Orange County excavation sequencing.",
    ...
    },
    {
      ...
      scope: "Utility trenching, phased cut/fill, and utility trenching on a county seat mixed-use commercial repositioning parcel with dense staging and adjacent building setback coordination.",
  ...
  media: {
    photos: [
      ...
      { src: heroImg, caption: "Placeholder — GPS utility trenching on dense Orange County Santa Ana parcel" },
    ...
    video: {
      poster: heroImg,
      caption: "Placeholder — Santa Ana commercial excavation site walk",
    },
  },
  ...
  tabbedInsights: {
    siteConditions: [
      ...
      "High-plasticity clay profiles on Santa Ana urban infill sites demand controlled moisture conditioning on every compaction lift before GPS utility trenching meets civil plan tolerances.",
    ],
    ourApproach: [
      ...
      "Phased mass excavation with tight haul route planning, alley staging, and daily export sized for dense Santa Ana urban parcels where stockpiling blocks excavation sequencing.",
    ...
    localPermits: [
      ...
      "Orange County environmental review and SWPPP compliance for active mass excavation and utility trenching on Santa Ana commercial sites.",
      "Export hauling coordination and haul route planning for excess cut material from dense Santa Ana infill parcels.",
      "Final grading inspection and excavation sequencing clearance required before foundation layout and vertical construction mobilization in Santa Ana.",
    ],
  },
};
